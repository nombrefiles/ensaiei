            ...
            <div class="modal-body">
                ...
                <div class="event-details">
                    <div class="detail-item">
                        <strong>▪ Data:</strong>
                        <span id="modalDate">Data do evento</span>
                    </div>
                    <div class="detail-item">
                        <strong>▪ Local:</strong>
                        <span id="modalLocation">Local do evento</span>
                    </div>
                    <div class="detail-item">
                        <strong>▪ Preço:</strong>
                        <span id="modalPrice">Preço do evento</span>
                    </div>
                    <div class="detail-item">
                        <strong>▪ Horário:</strong>
                        <span id="modalTime">19:00</span>
                    </div>
                    <div class="detail-item">
                        <strong>▪ Vagas:</strong>
                        <span id="modalCapacity">100 pessoas</span>
                    </div>
                    <div class="detail-item description">
                        <strong>▪ Descrição:</strong>
                        <p id="modalDescription">Descrição detalhada do evento...</p>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button class="btn-primary full-width" onclick="registerForEvent()">
